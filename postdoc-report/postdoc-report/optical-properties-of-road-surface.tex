...
According to the conversion method provided by \href{https://doi.org/10.25039/CIE.DS.dktna2s3}{CIE}, the photometric quantities can be derived by integrating the flux, irradiance or radiance weighted by the function $V(\lambda)$ over the whole visible region from $360nm$ to $830nm$:
...
The corresponding dataset of $V(\lambda)$ from $360 nm$ to $830 nm$ is provided by \href{https://doi.org/10.25039/CIE.DS.dktna2s3}{CIE}.
